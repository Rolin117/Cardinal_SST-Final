...
class Report extends FPDF
{
    ...
    const CLIENT_URL = 'http://localhost/Cardinal_SST-Final/views/private/';
    ...
    */
    public function startReport($title)
    {
        ...
        if (isset($_SESSION['id_administrador'])) {
            ...
            $this->setTitle('Cardinal - Reporte', true);
    ...
    */
    ...
    {   
        ...
        $this->cell(0, 7, 'Correo: ' . $usuario_info['correo_admin'], 0, 1, 'L');
        $this->cell(0, 7, 'Nombre: ' . $usuario_info['nombre_admin'], 0, 1, 'L');
...
{
    const CLIENT2_URL = 'http://localhost/Cardinal_SST-Final/views/public/';
