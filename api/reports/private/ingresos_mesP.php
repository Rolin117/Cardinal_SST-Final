...
$prediccion = new PedidoHandler;

// Se verifica si existen registros para mostrar, de lo contrario se imprime un mensaje.
if ($dataIngresosMes = $prediccion->prediccionIngresosMes()) {
    if (is_array($dataIngresosMes) && count($dataIngresosMes) > 0) {
        // Se inicia el reporte con el encabezado del documento.
        $pdf->startReport('Prediccion de Ingresos por Mes');
        ...
        $pdf->output('I', 'prediccion_ingresos_por_mes.pdf');
    } else {
        print('No hay prediccion de ingresos para mostrar');
    }
} else {
